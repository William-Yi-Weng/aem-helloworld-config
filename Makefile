...
gen-packer-aem:
	...
	$(call gen_packer_aem,aws,rhel7,aem65)
	$(call gen_packer_aem,aws,rhel8,aem62)
	$(call gen_packer_aem,aws,rhel8,aem63)
	$(call gen_packer_aem,aws,rhel8,aem64)
	$(call gen_packer_aem,aws,rhel8,aem65)
	$(call gen_packer_aem,aws,centos7,aem62)
	$(call gen_packer_aem,aws,centos7,aem63)
	$(call gen_packer_aem,aws,centos7,aem64)
	$(call gen_packer_aem,aws,centos7,aem65)
	...
	$(call gen_packer_aem,docker,amazon-linux2,aem65)
